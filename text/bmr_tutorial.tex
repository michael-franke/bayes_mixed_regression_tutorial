...
Figure~\ref{fig:PPC_without_gender} show the output of the following function call:
...
in Figure~\ref{fig:PPC_with_gender}. While still showing much uncertainty surrounding the two bumps in the observed distribution, it clearly captures the evidence better. 
...
Excellent textbooks on R are freely available online:
\begin{itemize}
