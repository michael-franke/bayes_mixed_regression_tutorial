...
\marginnote[-1.5cm]{Defining regularizing priors is essential for more complex models which estimate many parameters in order to ensure that your model converges and that it does so sufficiently quickly.}
