...
# A tibble: 3 x 2
  ...
  <chr>                                 <dbl>
1 Female-polite < Female-informal       0.99 
2 Male-polite < Male-informal           0.839
3 Male-informal < Female-polite         1    
\end{rc}
\end{minipage}

We would conclude from this that there is reason to believe, based on the currently assumed model and data, that hypotheses 1 and 3 are very likely true, but that there is ample room for doubt about hypothesis 2.
%
...
2 Male-polite < Male-informal           0.851
3 Male-informal < Female-polite         0.927
\end{rc}
\end{minipage}
